...
class TinyAuthAclRulesFixture extends TestFixture {
    ...
    public array $fields = [
        ...
        'path' => ['type' => 'string', 'length' => 250, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'created' => ['type' => 'datetime', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        'modified' => ['type' => 'datetime', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'acl-rules-path' => ['type' => 'unique', 'columns' => ['path', 'role'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
