...
/**
 * TinyAuthResourceAbilitiesFixture
 */
class TinyAuthResourceAbilitiesFixture extends TestFixture {
	 ...
	 * @var string
	 */
	public string $table = 'tinyauth_resource_abilities';
	...
	public array $fields = [
		...
		'_constraints' => [
			...
			'resource_id_name_unique' => ['type' => 'unique', 'columns' => ['resource_id', 'name'], 'length' => []],
		],
		'_options' => [
			'engine' => 'InnoDB',
